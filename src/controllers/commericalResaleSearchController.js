const commercialResaleModeal = require('../models/commercialRentModel');
...
const commericalResaleSearch = async function (req, res) {
    try {
        ...
        const searchData = await commercialResaleModeal.find(finalFilter)
...
const commercialResaleinterest = async function (req, res) {
    try {
        ...
        const isPropertyExist = await commercialResaleModeal.findById(propertyId).populate('userId')
...
module.exports = {
    commericalResaleSearch,
    commercialResaleinterest
}