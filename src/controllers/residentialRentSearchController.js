...
const residentalRentSearch = async function (req, res) {
    try {
        ...
        const searchData = await residentialRentModel.find(finalFilter)
...
const residentalRentinterest = async function (req, res) {
    try {
        ...
        const isPropertyExist = await residentialRentModel.findById(propertyId).populate('userId')
        ...
        await awsSNS.sendSMSForOwner(isPropertyExist.userId.phone, isUserExist.name, isUserExist.phone,"residential rent",isPropertyExist.locationDetails.city,isPropertyExist.locationDetails.locality)
...
module.exports = {
    residentalRentSearch,
    residentalRentinterest
}